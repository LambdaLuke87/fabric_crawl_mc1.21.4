...
public class WitherSkeletonFriendEntity extends SkeletonFriendEntity {

    public WitherSkeletonFriendEntity(EntityType<? extends WitherSkeletonFriendEntity> entityType, World world) {
    ...
    public EntityData initialize(ServerWorldAccess world, LocalDifficulty difficulty, SpawnReason spawnReason, @Nullable EntityData entityData) {
        ...
        Objects.requireNonNull(this.getAttributeInstance(EntityAttributes.ATTACK_DAMAGE)).setBaseValue((double)4.0F);
