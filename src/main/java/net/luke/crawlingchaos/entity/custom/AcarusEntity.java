...
public class AcarusEntity extends SpiderEntity {

    public AcarusEntity(EntityType<? extends AcarusEntity> entityType, World world) {
        ...
        if (super.tryAttack(world, target)) {
            if (target instanceof LivingEntity) {
                ...
                if (durationMultiplier > 0) {
                    ...
                    ((LivingEntity)target).addStatusEffect(new StatusEffectInstance(StatusEffects.MINING_FATIGUE, durationMultiplier * 20, 0), this);
                }
            }
            return true;
        }
