...
public class CarrierBugModel extends EntityModel<CommonRenderState> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData.addChild("head", ModelPartBuilder.create().uv(0, 20).cuboid(-3.0F, -3.0F, -5.1667F, 6.0F, 4.0F, 5.0F, new Dilation(0.0F))
                ...
                .uv(15, 30).cuboid(-2.0F, 0.0F, -7.1667F, 1.0F, 1.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 20.0F, -2.8333F));
        ModelPartData body = modelPartData.addChild("body", ModelPartBuilder.create().uv(20, 46).cuboid(-5.0F, -8.0F, -3.0F, 10.0F, 6.0F, 12.0F, new Dilation(0.0F))
                .uv(0, 11).cuboid(-3.0F, -7.0F, 8.0F, 6.0F, 4.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
        ...
        body.addChild("bone10", ModelPartBuilder.create().uv(32, 25).cuboid(-4.0F, -24.0F, -1.0F, 8.0F, 11.0F, 8.0F, new Dilation(0.0F))
                ...
                .uv(14, 35).cuboid(-2.0F, -23.0F, 6.0F, 4.0F, 8.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
        ModelPartData legr1 = modelPartData.addChild("legr1", ModelPartBuilder.create(), ModelTransform.pivot(-4.0F, 19.5F, 1.5F));
        ...
        ModelPartData legr2 = modelPartData.addChild("legr2", ModelPartBuilder.create(), ModelTransform.pivot(-4.0F, 18.5F, 2.5F));
        ...
        ModelPartData legr3 = modelPartData.addChild("legr3", ModelPartBuilder.create(), ModelTransform.pivot(-4.0F, 18.5F, 8.5F));
        ...
        ModelPartData legl1 = modelPartData.addChild("legl1", ModelPartBuilder.create(), ModelTransform.pivot(4.0F, 19.5F, 1.5F));
        ...
        ModelPartData legl2 = modelPartData.addChild("legl2", ModelPartBuilder.create(), ModelTransform.pivot(4.0F, 19.5F, 2.5F));
        ...
        ModelPartData legl3 = modelPartData.addChild("legl3", ModelPartBuilder.create(), ModelTransform.pivot(4.0F, 18.5F, 6.5F));
    ...
    public void setAngles(CommonRenderState commonState) {
        ...
        float f = commonState.limbFrequency * 0.6662F;
        float g = commonState.limbAmplitudeMultiplier;
