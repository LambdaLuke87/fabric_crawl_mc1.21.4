...
public class ParasiteWormModel extends EntityModel<CommonRenderState> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData head = root.addChild("head", ModelPartBuilder.create().uv(206, 0).cuboid(-4.5F, -4.75F, -16.0F, 9.0F, 9.0F, 16.0F, new Dilation(0.0F)), ModelTransform.origin(-0.5F, -27.25F, -18.0F));
        ...
        ModelPartData l_tusk_end = l_tusk_top.addChild("l_tusk_end", ModelPartBuilder.create(), ModelTransform.origin(-0.5F, 0.0F, -6.0F));
        ...
        root.addChild("tail", ModelPartBuilder.create().uv(156, 26).cuboid(-1.5F, -1.5F, -0.5F, 3.0F, 3.0F, 9.0F, new Dilation(0.0F)), ModelTransform.origin(-0.5F, -1.5F, 42.5F));
