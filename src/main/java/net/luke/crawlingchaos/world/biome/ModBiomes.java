...
public class ModBiomes {
    ...
    public static Biome testBiome(Registerable<Biome> context) {
        ...
        spawnBuilder.spawn(SpawnGroup.CREATURE, new SpawnSettings.SpawnEntry(ModEntities.ERODED_ZOMBIE, 2, 3, 5));

        spawnBuilder.spawn(SpawnGroup.CREATURE, new SpawnSettings.SpawnEntry(EntityType.CAVE_SPIDER, 5, 4, 4));
